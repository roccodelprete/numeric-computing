function koch_frattale2(p)

%   prima variante della curva di Kock  
%   la function non si ferma autonomamente, 
%   ma e' necessario premere sul
%   bottone stop

%   questa function differisce dalla prima per la terza trasformazione
...
set(gcf,'color','white','menubar','none', ...
   'numbertitle','off','name','Curva di Koch - 2')
x = [0; 0];
h = plot(x(1),x(2),'.');
darkgreen = [0 2/3 0];
...
%                      una rotazione antioraria di angolo 2pi/3
%                      un'omotetia di centro (0,0) e rapporto 1/3, 
